...
| `mc-26.2` | 26.2 | `26.2.20261002` | 开发中 |
...
- 金币系统（`/money` 查余额；`/money give 数量 玩家名` 转帐，对方可不在线且需余额充足；`/request 数量 玩家名` 向在线玩家索要，对方在 30 秒内 `/accept` 且余额充足后到账；金币与账号绑定，新注册默认 500，SQLite 存储）
